...
ALTER TABLE `post_rates`
  ...
  ADD KEY `post_rates_ibfk_2` (`id_u`);
...
--
-- Ограничения внешнего ключа таблицы `post_rates`
--
ALTER TABLE `post_rates`
  ADD CONSTRAINT `post_rates_ibfk_1` FOREIGN KEY (`id_p`) REFERENCES `Posts` (`id_p`) ON DELETE CASCADE,
  ADD CONSTRAINT `post_rates_ibfk_2` FOREIGN KEY (`id_u`) REFERENCES `Users` (`Id_U`) ON DELETE CASCADE;
